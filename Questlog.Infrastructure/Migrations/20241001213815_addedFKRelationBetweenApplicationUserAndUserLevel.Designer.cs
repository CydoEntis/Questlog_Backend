...
namespace Questlog.Infrastructure.Migrations
{
    ...
    [Migration("20241001213815_addedFKRelationBetweenApplicationUserAndUserLevel")]
    partial class addedFKRelationBetweenApplicationUserAndUserLevel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Questlog.Domain.Entities.UserLevel", b =>
                {
                    b.HasOne("Questlog.Domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("UserLevel")
                        .HasForeignKey("Questlog.Domain.Entities.UserLevel", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
